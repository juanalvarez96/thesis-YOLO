...
def get_args_parser():
    ...
    # dataset parameters
    parser.add_argument('--img_path', default='/home/juan.vallado/data/DAVIS/JPEGImages/480p/')
    parser.add_argument('--ann_path', default='/workspace/annotation/annotations_vis_val.json')
